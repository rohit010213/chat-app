...
export const signup = async(req,res)=>{
  ...
  try {
    ...
    if(user){
        return res.status(400).json({message : "The email is already exist use a different email"});
    }
...
export const updateProfile = async(req,res)=>{
  try {
      ...
      console.log("Upload profile error",error.message);
      res.status(500).json({message:"error occur in updateProfile"})
  }
}
